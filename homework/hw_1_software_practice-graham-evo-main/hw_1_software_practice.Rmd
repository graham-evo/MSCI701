...
Make sure the `title`, `author` and `date` parameters are correct in the RMarkdown YAML at the top of the file. Please save your `.Rmd` file with the name `HW_1_your_last_name.Rmd`. Make sure this file knits successfully into an `.html` file. Commit, pull and push all of the changes to your private homework repository back onto GitHub for me to grade. If you loaded your data in from a separate file, make sure you push this file as well. 
